...
function productPage(product) {
  ...
  return `<!doctype html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>${name} Wholesale | HANSEONG BEAUTY GLOBAL</title><meta name="description" content="${desc}"><link rel="canonical" href="${url}"><meta property="og:type" content="product"><meta property="og:title" content="${name} Wholesale | HANSEONG BEAUTY GLOBAL"><meta property="og:description" content="${desc}"><meta property="og:image" content="${SITE}/${product.image}"><link rel="icon" href="/assets/icons/logo.png"><link href="https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600&family=Manrope:wght@600;700&family=Plus+Jakarta+Sans:wght@600;700;800&display=swap" rel="stylesheet"><link rel="stylesheet" href="/assets/css/style.css?v=20260727"><script type="application/ld+json">${ld}</script></head><body class="article-page"><nav class="nav"><div class="wrap nav-inner"><a class="brand brand-logo" href="/index.html"><img src="/assets/icons/logo-header.png" alt="HANSEONG BEAUTY GLOBAL"></a><div class="article-nav"><a href="/products.html">â† All products</a><a class="btn primary" href="/products.html">Build a quote list</a></div></div></nav><main><header class="article-hero"><div class="wrap article-wrap"><span>${category.toUpperCase()} Â· WHOLESALE</span><h1>${name}</h1><p>${desc}</p><div class="article-meta"><a href="/index.html">Home</a> â€º <a href="/products.html">Products</a> â€º ${name}</div></div></header><div class="article-cover wrap"><img src="${image}" alt="${name}" loading="lazy"></div><article class="article-body article-wrap"><p class="article-intro">HANSEONG BEAUTY GLOBAL supports professional buyers with wholesale sourcing, product availability checks, documentation support and international shipping coordination for ${name}.</p><h2>About ${name}</h2><p>${name} is listed in our professional ${category.toLowerCase()} catalogue for clinics, spas, resellers and distribution partners. Product availability may vary by destination market, quantity and current supply schedule.</p><h2>Wholesale sourcing notes</h2><p>Before placing an order, buyers normally confirm product image, quantity, destination country, shipping preference and any import documentation required by their local process.</p><ul><li><strong>Brand:</strong> ${brand}</li><li><strong>Origin:</strong> ${origin}</li><li><strong>Category:</strong> ${category}</li><li><strong>Support:</strong> WhatsApp quotation, stock check and shipment coordination.</li></ul><h2>Request quotation</h2><p>Send your product list and destination country through WhatsApp. Our team will help check current availability and quote options for wholesale buyers.</p><div class="article-end"><h2>Request a wholesale quote for ${name}</h2><p>Send your destination country and quantity. Our team will help you check current availability and shipping options.</p><a class="btn primary" href="${waLink}">Request quotation on WhatsApp â†’</a></div><p class="disclaimer">General procurement information for professional buyers. Not medical, legal, regulatory or import advice. Product availability varies by market.</p></article></main><footer class="footer new-footer"><div class="wrap"><div class="footer-top"><div><img src="/assets/icons/logo-header.png" alt="HANSEONG BEAUTY GLOBAL"><p>Professional aesthetic wholesale supply for clinics, spas, resellers and distributors worldwide.</p></div><div><b>Explore</b><a href="/products.html">Products</a><a href="/brands.html">Brands</a><a href="/blog/index.html">Journal</a></div><div><b>Company</b><a href="/about.html">About HANSEONG</a><a href="/faq.html">FAQ</a><a href="/contact.html">Contact</a></div><div><b>Connect</b><a href="https://wa.me/84921909928">WhatsApp</a><a href="mailto:hanseongbeauty@gmail.com">Email sales</a></div></div><div class="footer-bottom"><span>Â© 2026 HANSEONG BEAUTY GLOBAL</span><span>Professional buyers only Â· Availability varies by market</span></div></div></footer><script src="/assets/js/main.js?v=20260727"></script></body></html>`;
}
