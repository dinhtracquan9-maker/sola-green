...
REAL_IMAGE_RULES = [
    ...
    (("allergan",), "../assets/images/Allergan ảnh full.jpg"),
    (("botulax",), "../assets/images/Botulax ảnh full.jpg"),
    (("juvederm",), "../assets/images/Juvederm anh dep.jpg"),
    (("nabota",), "../assets/images/Nabota ảnh gốc 1.jpg"),
    (("rejuran",), "../assets/images/Rejuran new.jfif"),
]
