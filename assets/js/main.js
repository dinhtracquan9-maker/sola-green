...
function renderSiteChrome() {
  ...
  const inProducts = location.pathname.replace(/\\/g, '/').includes('/products/');
  ...
  const header = `<div class="topbar"><div class="wrap topbar-grid"><div class="top-socials" aria-label="HANSEONG social channels"><span>Follow</span><a href="https://www.instagram.com/hanseong_beauty_global/" target="_blank" rel="noopener" aria-label="Instagram">${instagramIcon}</a><a href="https://www.facebook.com/hanseongbeautyglobal/" target="_blank" rel="noopener" aria-label="Facebook">${facebookIcon}</a><a href="https://t.me/+3aZiyqL7GRQyMDBl" target="_blank" rel="noopener noreferrer" aria-label="Telegram">${telegramIcon}</a></div><span class="topbar-note">Professional B2B aesthetic supply · Korea & Vietnam</span><a class="top-wa" data-wa><i></i> WhatsApp +84 92 190 99 28</a></div></div>
    <nav class="nav nav-2026"><div class="wrap"><div class="nav-inner"><div class="links"><div class="mobile-menu-head"><span>Explore</span><b>HANSEONG BEAUTY</b></div><a${active('index')} href="${base}index.html">Home</a><a${active('products')} href="${base}products.html">Products</a><a${active('brands')} href="${base}brands.html">Brands</a><a${active('about')} href="${base}about.html">About</a><a${active('journal')} href="${base}blog/index.html">Journal</a><a class="nav-mobile-only" href="${base}shipping.html">Shipping</a><a class="nav-mobile-only" href="${base}faq.html">FAQ</a><a class="nav-mobile-only" href="${base}contact.html">Contact</a><a class="nav-mobile-only nav-mobile-community" href="https://t.me/+3aZiyqL7GRQyMDBl" target="_blank" rel="noopener noreferrer">Telegram community</a><a class="btn primary nav-mobile-quote" data-wa>Get a wholesale quote on WhatsApp</a></div><a class="brand brand-logo" href="${base}index.html" aria-label="HANSEONG BEAUTY GLOBAL home"><img src="${base}assets/icons/logoHeader.png" alt="HANSEONG BEAUTY GLOBAL"></a><div class="nav-actions"><details class="nav-more"><summary>More <span>⌄</span></summary><div><a${active('shipping')} href="${base}shipping.html">Shipping</a><a${active('faq')} href="${base}faq.html">FAQ</a><a${active('contact')} href="${base}contact.html">Contact</a></div></details><a class="nav-community" href="https://t.me/+3aZiyqL7GRQyMDBl" target="_blank" rel="noopener noreferrer"><i></i> Community</a><a class="nav-whatsapp" data-wa aria-label="Get a wholesale quote on WhatsApp"><svg viewBox="0 0 32 32" aria-hidden="true"><path d="M16 3A13 13 0 0 0 5 23l-2 6 6-2a13 13 0 1 0 7-24Zm0 23a10 10 0 0 1-5-1.3l-.7-.4-3.4 1 1.1-3.2-.4-.7A10 10 0 1 1 16 26Zm5.5-7.5c-.3-.2-1.8-.9-2.1-1-.3-.1-.5-.2-.7.2l-1 1.2c-.2.2-.4.2-.7.1-1.9-.9-3.2-2.2-4.1-4-.2-.3 0-.5.1-.7l.7-.8c.2-.2.2-.4.3-.6.1-.2 0-.5 0-.7l-1-2.3c-.2-.5-.5-.5-.7-.5h-.6c-.2 0-.6.1-.9.4-.3.3-1.2 1.2-1.2 2.9s1.2 3.4 1.4 3.6c.2.2 2.4 3.7 5.9 5.1.8.4 1.5.6 2 .7.8.3 1.6.2 2.2.1.7-.1 1.8-.8 2.1-1.5.3-.7.3-1.4.2-1.5-.1-.1-.3-.2-.6-.4Z"/></svg><span>WhatsApp quote</span></a><button class="menu" type="button" aria-label="Open navigation" aria-expanded="false"><span></span><span></span><span></span><b>Menu</b></button></div></div></div></nav>`;
  document.querySelector('.topbar')?.remove();
  document.querySelector('.nav')?.remove();
  document.body.insertAdjacentHTML('afterbegin', header);

  const footer = `<footer class="footer new-footer"><div class="wrap"><div class="footer-top"><div class="footer-brand"><div class="footer-logo"><img src="${base}assets/icons/logoFooter.png" alt="HANSEONG BEAUTY GLOBAL"></div><p>Professional aesthetic wholesale supply for clinics, spas, resellers and distributors worldwide.</p><div class="footer-social" aria-label="HANSEONG social channels"><a href="https://www.instagram.com/hanseong_beauty_global/" target="_blank" rel="noopener" aria-label="Instagram">${instagramIcon}</a><a href="https://www.facebook.com/hanseongbeautyglobal/" target="_blank" rel="noopener" aria-label="Facebook">${facebookIcon}</a><a href="https://t.me/+3aZiyqL7GRQyMDBl" target="_blank" rel="noopener noreferrer" aria-label="Telegram">${telegramIcon}</a></div></div><div><b>Explore</b><a href="${base}products.html">Products</a><a href="${base}brands.html">Brands</a><a href="${base}shipping.html">Shipping</a><a href="${base}blog/index.html">Journal</a><a href="${base}about.html">About HANSEONG</a></div><div><b>Contact</b><a data-wa>WhatsApp Vietnam: +84 92 190 99 28</a><a class="wa-korea">WhatsApp Korea: +82 10-2189-2675</a><a href="mailto:hanseongbeauty@gmail.com">hanseongbeauty@gmail.com</a></div><div class="footer-addresses"><b>Our offices</b><address><strong>Korea Headquarters</strong>Seoul Finance Center, 36 Sejong-daero, Jung-gu, Seoul 04520, South Korea</address><address><strong>Vietnam Office</strong>Kim Hoan Building, 19 Duy Tan, Cau Giay District, Hanoi 113000, Vietnam</address></div></div><div class="footer-bottom"><span>© 2026 HANSEONG BEAUTY GLOBAL</span><span>Professional buyers only · Product availability varies by market</span></div></div></footer>`;
